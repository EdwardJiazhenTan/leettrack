...
describe('/api/auth/login', () => {
  ...
  describe('POST', () => {
    it('should login user successfully with valid credentials', async () => {
      ...
      expect(mockedFindUserByEmail).toHaveBeenCalledWith(mockLoginRequest.email);
      expect(mockedVerifyPassword).toHaveBeenCalledWith(mockLoginRequest.password, mockUserWithPassword.password_hash);
      expect(mockedCreateSession).toHaveBeenCalledWith(mockUserWithPassword.user_id);
    });
