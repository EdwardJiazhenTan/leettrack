...
const mockedGetQuestionStats = getQuestionStats as jest.MockedFunction<
  typeof getQuestionStats
>;
...
describe("/api/questions/stats", () => {
  ...
  describe("GET", () => {
    ...
    it("should return 500 error when an exception occurs", async () => {
      ...
      expect(responseData.message).toBe("Failed to fetch question statistics");
    });
  });
});
