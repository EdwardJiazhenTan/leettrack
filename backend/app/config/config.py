...
class Config:
    ...
    DB_HOST = os.environ.get(
        "DB_HOST", "database-1.ccri0seewfxp.us-east-1.rds.amazonaws.com"
    )
    ...
    # External APIs
    LEETCODE_API_BASE_URL = os.environ.get(
    ...
    NEW_QUESTIONS_PER_DAY = (
        1  # Default new questions per day (will be user configurable later)
    )
