...
class ScheduledReview(db.Model):
    ...
    schedule_id = db.Column(
        db.Integer,
        db.ForeignKey("review_schedule.schedule_id", ondelete="CASCADE"),
        nullable=False,
    )
    user_question_id = db.Column(
        db.Integer,
        db.ForeignKey("user_questions.user_question_id", ondelete="CASCADE"),
        nullable=False,
    )
    ...
    __table_args__ = (
        db.UniqueConstraint(
            "schedule_id", "user_question_id", name="schedule_question_unique"
        ),
    )
