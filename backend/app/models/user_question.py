...
class UserQuestion(db.Model):
    ...
    review_confidence = db.Column(
        db.String(20)
    )  # 'mastered', 'confident', 'understood', 'struggled', 'confused'
    ...
    needs_rating = db.Column(
        db.Boolean, default=True
    )  # Whether user needs to rate this question
    ...
    scheduled_reviews = db.relationship(
        "ScheduledReview", back_populates="user_question", cascade="all, delete-orphan"
    )
