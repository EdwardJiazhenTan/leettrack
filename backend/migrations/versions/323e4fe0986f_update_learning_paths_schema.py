...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["path_question_id"],
            ["path_questions.path_question_id"],
        ),
        sa.ForeignKeyConstraint(
            ["user_path_id"],
            ["user_learning_paths.user_path_id"],
        ),
    ...
    with op.batch_alter_table("path_questions", schema=None) as batch_op:
        ...
        batch_op.alter_column("path_id", existing_type=sa.INTEGER(), nullable=False)
        ...
        batch_op.drop_constraint(
            batch_op.f("path_questions_path_id_question_id_key"), type_="unique"
        )
        batch_op.drop_constraint(
            batch_op.f("path_questions_path_id_sequence_number_key"), type_="unique"
        )
        batch_op.create_unique_constraint(
            "uq_path_question", ["path_id", "question_id"]
        )
        batch_op.create_unique_constraint(
            "uq_path_sequence", ["path_id", "sequence_number"]
        )
        batch_op.drop_constraint(
            batch_op.f("path_questions_path_id_fkey"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("path_questions_question_id_fkey"), type_="foreignkey"
        )
    ...
    with op.batch_alter_table("review_schedule", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("review_schedule_user_id_review_date_key"), type_="unique"
        )
        batch_op.create_unique_constraint(
            "user_date_unique", ["user_id", "review_date"]
        )
    ...
    with op.batch_alter_table("scheduled_reviews", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "user_question_id", existing_type=sa.INTEGER(), nullable=False
        )
        batch_op.drop_index(batch_op.f("idx_scheduled_reviews_schedule_id"))
        batch_op.drop_constraint(
            batch_op.f("scheduled_reviews_schedule_id_user_question_id_key"),
            type_="unique",
        )
        batch_op.create_unique_constraint(
            "schedule_question_unique", ["schedule_id", "user_question_id"]
        )
    ...
    with op.batch_alter_table("user_questions", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("user_questions_user_id_question_id_key"), type_="unique"
        )
        batch_op.create_unique_constraint(
            "user_question_unique", ["user_id", "question_id"]
        )
...
def downgrade():
    ...
    with op.batch_alter_table("user_questions", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            batch_op.f("user_questions_user_id_question_id_key"),
            ["user_id", "question_id"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_index(
            batch_op.f("idx_user_questions_user_id"), ["user_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_user_questions_next_review"), ["next_review"], unique=False
        )
    ...
    with op.batch_alter_table("scheduled_reviews", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            batch_op.f("scheduled_reviews_schedule_id_user_question_id_key"),
            ["schedule_id", "user_question_id"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_index(
            batch_op.f("idx_scheduled_reviews_schedule_id"),
            ["schedule_id"],
            unique=False,
        )
        batch_op.alter_column(
            "user_question_id", existing_type=sa.INTEGER(), nullable=True
        )
        batch_op.alter_column("schedule_id", existing_type=sa.INTEGER(), nullable=True)

    with op.batch_alter_table("review_schedule", schema=None) as batch_op:
        batch_op.drop_constraint("user_date_unique", type_="unique")
        batch_op.create_unique_constraint(
            batch_op.f("review_schedule_user_id_review_date_key"),
            ["user_id", "review_date"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_index(
            batch_op.f("idx_review_schedule_user_date"),
            ["user_id", "review_date"],
            unique=False,
        )
        batch_op.alter_column("user_id", existing_type=sa.INTEGER(), nullable=True)
    ...
    with op.batch_alter_table("path_questions", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("path_questions_question_id_fkey"),
            "questions",
            ["question_id"],
            ["question_id"],
            ondelete="CASCADE",
        ...
        batch_op.create_foreign_key(
            batch_op.f("path_questions_path_id_fkey"),
            "learning_paths",
            ["path_id"],
            ["path_id"],
            ondelete="CASCADE",
        ...
        batch_op.create_unique_constraint(
            batch_op.f("path_questions_path_id_sequence_number_key"),
            ["path_id", "sequence_number"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_unique_constraint(
            batch_op.f("path_questions_path_id_question_id_key"),
            ["path_id", "question_id"],
            postgresql_nulls_not_distinct=False,
        )
        batch_op.create_index(
            batch_op.f("idx_path_questions_path_id"), ["path_id"], unique=False
        )
        batch_op.alter_column("question_id", existing_type=sa.INTEGER(), nullable=True)
        batch_op.alter_column("path_id", existing_type=sa.INTEGER(), nullable=True)
    ...
    op.create_table(
        ...
        sa.Column(
            "project_name", sa.VARCHAR(length=200), autoincrement=False, nullable=False
        ),
        ...
        sa.CheckConstraint(
            ...
            name=op.f("sample_projects_priority_check"),
        ),
        sa.PrimaryKeyConstraint("project_id", name=op.f("sample_projects_pkey")),
    )
    with op.batch_alter_table("sample_projects", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("idx_sample_projects_status"), ["status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_sample_projects_priority"), ["priority"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_sample_projects_dates"),
            ["start_date", "end_date"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_sample_projects_created"), ["created_at"], unique=False
        )
